...
- [NameTag](https://dupedb.net/exploit/jVPtq3pxqVO) had a minimessage exploit that allows you to inject some minimessage payloads into a username providing it doesnt have 